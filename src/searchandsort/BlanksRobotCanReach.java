...
//            count = 1 + backTracking(dfsandbfs.matrix, threshold, visited, row + 1, col) +
//            backTracking(dfsandbfs.matrix, threshold, visited, row - 1, col) +
//            backTracking(dfsandbfs.matrix, threshold, visited, row, col + 1) +
//            backTracking(dfsandbfs.matrix, threshold, visited, row, col - 1) ;
        }
        return count;
    }
